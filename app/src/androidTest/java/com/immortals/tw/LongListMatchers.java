...
public final class LongListMatchers {
  ...
  public static Matcher<Object> withItemPayContent(String expectedText) {
    // use preconditions to fail fast when a test is creating an invalid matcher.
    checkNotNull(expectedText);
    return withItemPayContent(equalTo(expectedText));
  }
   ...
   */
  @SuppressWarnings("rawtypes")
  public static Matcher<Object> withItemPayContent(final Matcher<String> itemTextMatcher) {
    // use preconditions to fail fast when a test is creating an invalid matcher.
    checkNotNull(itemTextMatcher);
    return new BoundedMatcher<Object, String>(String.class) {
      @Override
      public boolean matchesSafely(String str) {
        return str.equals(itemTextMatcher);
      }
